...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove Vesper. The Hermes Agent core, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove Vesper and the Hermes Agent core, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'Vesper and the Hermes Agent core (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — Vesper, the Hermes Agent core, and all of your config, chats, secrets, and logs',
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Uninstall Vesper</p>
