...
export const en: Translations = {
  ...
  boot: {
    ready: 'Vesper Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Vesper settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Vesper Desktop…'
    },
    errors: {
      backgroundExited: 'Vesper background process exited.',
      backgroundExitedDuringStartup: 'Vesper background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Vesper backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Vesper',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Vesper Desktop.',
    ...
    native: {
      ...
      inputBody: 'Vesper is waiting for your response.',
      turnDoneTitle: 'Vesper finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Vesper defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Vesper is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Vesper asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Vesper was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Vesper follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Vesper is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Vesper, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Vesper checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Vesper configuration...',
    ...
    gateway: {
      ...
      intro:
        'Vesper Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Vesper backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Vesper backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Vesper backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Vesper Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Vesper ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Vesper runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As Vesper builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Vesper to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Vesper to generate pets.',
      backgroundHint: 'You can close this — Vesper will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Vesper desktop' },
    ...
    hermesActiveSessions: (version, count) => `Vesper ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Vesper environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Vesper will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Vesper backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Vesper. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Vesper...',
    placeholderReconnecting: 'Reconnecting to Vesper…',
    ...
    attachUrlDesc: 'Vesper will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Vesper to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Vesper…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Vesper…',
    ...
    unsupportedMessage: 'This version of Vesper can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Vesper is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Vesper backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Vesper from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Vesper will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Vesper desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Vesper updater takes over in its own window and reopens Vesper automatically when it’s done. Please don’t reopen Vesper yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Vesper reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Vesper reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Vesper needs a one-time install',
    ...
    settingUpTitle: 'Setting up Vesper Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Vesper CLI or desktop instance is running. Stop any running Vesper instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Vesper installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Vesper Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Vesper is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Vesper…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Vesper',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Vesper at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Vesper connects automatically',
    ...
    authorizeThere: 'Authorize Vesper there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Vesper there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Vesper Desktop v${version}`,
      ...
      gatewayTitle: 'Vesper inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Vesper will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Vesper is restarting...',
      askRestart: 'Ask Vesper to restart the server',
      lookingRestart: taskId => `Vesper is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Vesper is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Vesper finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Vesper could not restart the server.',
      stillWorking:
        'Vesper is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Vesper is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Vesper gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Vesper won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Vesper needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Vesper needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Vesper Desktop to use Save Image.',
    restartToSaveImages: 'Restart Vesper Desktop to save images',
